                  ...
                  <GlassCard key={split.id} colSpan="md:col-span-6 lg:col-span-4">
                    <div className="flex flex-col h-full">
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <div className="text-sm text-slate-400 mt-1">
                            {split.daysPerWeek} days • {getTemplateDisplayName(split)}
                          </div>
                        </div>
                        <div className="flex">
                          <button
                      ...
                      <div className="mb-3 flex-1">
                        <div className="text-sm text-slate-400 mb-2">Training Days</div>
                        <div className="flex flex-wrap gap-1">
                          {split.days.map((day, index) => (
                            <div 
                              key={index}
                              className="inline-block px-2 py-1 bg-slate-800 text-slate-300 text-xs rounded"
                            >
                              {day.name}
                            </div>
                          ))}
